...
class FuncaoExercidaUsuarioDAO {
	...
	public function cadastrar($nome, $status) {
		...
		try {
			...
			$sql = "INSERT INTO funcao_exercida (nome, status) 
			VALUES ('" . $nome . "', '" . $status . "')";
	...
	public function lista(){
		...
		$sql = "SELECT * FROM funcao_exercida WHERE status LIKE 'ativado'";
	...
	public function VerificarNome($nome){
		...
		$sql = "SELECT * FROM funcao_exercida 
